...
const countOccurrences = (array, value) =>
    array.reduce((accumulator, currentVal) => (currentVal === value ? accumulator + 1 : accumulator), 0);
...
console.log('8: Should print new list of dinos but with Flip-Flop-Saurus at the top');
